  ...
  ($.fn.mauGallery = function (options) {
      ...
      return this.each(function () {
          $.fn.mauGallery.methods.createRowWrapper($(this)),
              options.lightBox && $.fn.mauGallery.methods.createLightBox($(this), options.lightboxId, options.navigation),
              ...
              options.showTags && $.fn.mauGallery.methods.showItemTags($(this), options.tagsPosition, tagsCollection),
              $(this).fadeIn(500);
      });
  }),
      ...
      ($.fn.mauGallery.methods = {
          ...
          filterByTag() {
              if (!$(this).hasClass("active-tag")) {
                  $(".active-tag").removeClass("active active-tag"), $(this).addClass("active-tag"), $(this).addClass("active");
